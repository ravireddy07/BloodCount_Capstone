...
handleBloodGroup = (text) => {
 ...
 signup = (email, pass,fullname,city,address,bloodgroup) => {
  const LOGINurl="http://blookbank.flashcontacts.org/Home/AddUser?username="+email+"&password="+pass+"&fullname="+fullname+"&city="+city+"&address="+address+"&bloodgroup="+bloodgroup+"&type=USER";
  fetch(LOGINurl)
      ...
      <ScrollView
        ...
        <View style={styles.getStartedContainer}>
          ...
          <Text style={styles.getStartedText}>
            Create your Blood Count App Account
          </Text>
