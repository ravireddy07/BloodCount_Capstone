...
import { Linking } from 'expo';
  ...
  savedata(city,group,units,userid)
  {
    const LOGINurl="http://blookbank.flashcontacts.org/Home/AddBloodBank?city="+city+"&bloodgroup="+group+"&nounit="+units+"&userid="+userid;
...
<TextInput style = {styles.input}
               ...
               onPress = {
                  () => this.savedata(this.state.city,this.state.bloodgroup,this.state.bloodunits,this.state.userid)
               }>
