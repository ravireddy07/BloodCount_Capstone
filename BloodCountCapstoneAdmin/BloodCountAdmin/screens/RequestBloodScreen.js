...
import * as SMS from 'expo-sms';
   ...
   export default class RequestBloodScreen extends React.Component {
    state = {
      userid: '',
      username: '',
      bloodgroup:'',
  ...
  async savedata(city,group,units,userid,mobileno)
  {
    ...
    if (isAvailable) {
      const { result } = await SMS.sendSMSAsync(
        [mobileno],
        'I am Requesting Blood Group '+ group +", in city "+city+", "+units
      );
    } else {
...
RequestBloodScreen.navigationOptions = {
  title: 'Request Blood',
};
